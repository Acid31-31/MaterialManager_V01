# MIGRATION 1.0.x → V01 - ALLES IN EINEM!
# MASTER-SCRIPT: Kopieren + Umbenennen + Demo Reset + Build + Start

Write-Host ""
Write-Host "╔════════════════════════════════════════════════════════════════════╗" -ForegroundColor Cyan
Write-Host "║                                                                    ║" -ForegroundColor Cyan
Write-Host "║          🚀 MATERIALMANAGER 1.0.x → V01 KOMPLETT-MIGRATION 🚀       ║" -ForegroundColor Cyan
Write-Host "║                                                                    ║" -ForegroundColor Cyan
...
Write-Host "[1/4] KOPIERE 1.0.x → D:\MaterialManager_V01_komplett..." -ForegroundColor Yellow
Write-Host ""

if (-not (Test-Path $source)) {
    Write-Host "❌ FEHLER: 1.0.x nicht gefunden!" -ForegroundColor Red
    pause
    exit 1
}
...
Write-Host "[2/4] ÄNDERE ALLE 1.0.x → V01..." -ForegroundColor Yellow
Write-Host ""

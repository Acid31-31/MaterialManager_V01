# 🎯 MaterialManager 1.0.x - Präsentations-Checkliste
...
```
Betreff: MaterialManager 1.0.x - Präsentation

Hallo zusammen,

anbei erhaltet ihr die MaterialManager 1.0.x Präsentations-Version.

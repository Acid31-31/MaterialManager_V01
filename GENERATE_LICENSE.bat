@echo off
REM ============================================
REM LizenzschlÃ¼ssel Generator
REM ============================================
...
echo.
echo ============================================
echo MaterialManager 1.0.x - LizenzschlÃ¼ssel
echo ============================================
echo.
...
Write-Host ''; ^
Write-Host 'LizenzschlÃ¼ssel generiert:' -ForegroundColor Green; ^
Write-Host $licenseKey -ForegroundColor Yellow; ^
Write-Host ''; ^
Write-Host 'Details:' -ForegroundColor Cyan; ^
Write-Host ('  Hardware-ID: {0}' -f $hardwareId); ^
Write-Host ('  Kunde: {0}' -f $customer); ^
Write-Host ('  GÃ¼ltig bis: {0}' -f $expiryDate); ^
Write-Host '';"

echo.
echo Senden Sie diesen SchlÃ¼ssel an den Kunden.
echo.
pause

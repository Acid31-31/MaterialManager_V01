# MaterialManager 1.0.x - VOLLSTÄNDIGER AUTOMATIC BUILD
...
Write-Title "MATERIALMANAGER 1.0.x - VOLLSTÄNDIGER AUTOMATIC BUILD (MIT ADMIN-RECHTEN)" "Cyan"
...
Write-Host "  🎉 MATERIALMANAGER 1.0.x - READY FOR DISTRIBUTION 🎉" -ForegroundColor Green
Write-Host "════════════════════════════════════════════════════════════════" -ForegroundColor Green
Write-Host ""

...
REM  MaterialManager 1.0.x - Alexander HÃ¶lzer
REM â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•

title MaterialManager 1.0.x - Personalisierung
color 0A

cls
echo.
echo â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
echo               MATERIALMANAGER 1.0.x - AUTOMATISCHE PERSONALISIERUNG
echo â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
echo.
echo  Dieses Script ersetzt automatisch alle Platzhalter in deinen Dateien:
echo.
echo  [DEIN NAME]         -^> Alexander HÃ¶lzer
...
REM PrÃ¼fe ob PowerShell verfÃ¼gbar
...
REM FÃ¼hre PowerShell-Script aus

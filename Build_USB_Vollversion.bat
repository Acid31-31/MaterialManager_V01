...
title MaterialManager 1.0.x - USB-Vollversion erstellen
color 0B
chcp 65001 >nul
...
echo.
echo ╔═══════════════════════════════════════════════════════════════════════════════╗
echo ║          MATERIALMANAGER 1.0.x - USB-VOLLVERSION PAKET ERSTELLEN                ║
echo ╚═══════════════════════════════════════════════════════════════════════════════╝
echo.
...
(
echo @echo off
echo title MaterialManager 1.0.x - Lizenzschlüssel Generator
echo color 0E
echo cls
echo.
echo ══════════════════════════════════════════════════════════════════════════════
...
echo.
echo Starte MaterialManager_1.0.x.exe mit Parameter: --generate-license "%%HWID%%" %%TYPE%%
echo.
start /WAIT "" "App\MaterialManager_1.0.x.exe" --generate-license "%%HWID%%" %%TYPE%%
echo.
echo ──────────────────────────────────────────────────────────────────────────────
echo.
...
echo icon=App\MaterialManager_1.0.x.exe
echo label=MaterialManager 1.0.x - Vollversion Installer
echo action=MaterialManager 1.0.x installieren
...
(
echo ═══════════════════════════════════════════════════════════════════════════════
echo  MATERIALMANAGER 1.0.x - VOLLVERSION USB-PAKET
echo ═══════════════════════════════════════════════════════════════════════════════
echo.

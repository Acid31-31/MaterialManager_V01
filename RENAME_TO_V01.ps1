...
# Ersetzt alle 1.0.x Referenzen durch V01
...
Write-Host "║                      PHASE 2: UMBENENNUNG 1.0.x → V01                         ║" -ForegroundColor Cyan
Write-Host "║                                                                               ║" -ForegroundColor Cyan
Write-Host "║                   Ersetze alle 1.0.x-Referenzen mit V01                        ║" -ForegroundColor Cyan
Write-Host "╚═══════════════════════════════════════════════════════════════════════════════╝" -ForegroundColor Cyan
Write-Host ""
